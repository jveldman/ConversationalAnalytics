...
- "data": asks for counts, totals, trends, comparisons, filters on real data. Also includes questions on governance, such as owners, stewards or contact details. These can be found in similarly named columns within the semantic models.
